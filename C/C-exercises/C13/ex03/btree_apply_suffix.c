...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/17 10:56:40 by cel-hajj          #+#    #+#             */
/*   Updated: 2025/08/17 12:51:23 by cel-hajj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	btree_apply_suffix(tree1, &print_node);
	printf("\n");

	printf("Postorder Traversal of Tree 2:\n");
	btree_apply_suffix(tree2, &print_node);
	printf("\n");
	
	printf("Postorder Traversal of Tree 3:\n");
	btree_apply_suffix(tree3, &print_node);
