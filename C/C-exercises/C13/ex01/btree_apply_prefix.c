...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/17 10:23:57 by cel-hajj          #+#    #+#             */
/*   Updated: 2025/08/17 12:50:25 by cel-hajj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	btree_apply_prefix(tree1, &print_node);
	printf("\n");
	...
	printf("Preorder Traversal of Tree 3:\n");
	btree_apply_prefix(tree3, &print_node);
